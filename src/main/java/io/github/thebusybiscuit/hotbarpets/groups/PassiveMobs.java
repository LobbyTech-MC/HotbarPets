...
public final class PassiveMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new IronGolemPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_IRON_GOLEM", PetTexture.IRON_GOLEM_PET.getHash(), "&7铁傀儡 &f宠物", getName(), "&7喜欢的食物: 铁锭", "", "&f右键: &7获得抗性提升"), new ItemStack(Material.IRON_INGOT), new ItemStack[]{
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_SLIME", PetTexture.SLIME_PET.getHash(), "&a史莱姆 &f宠物", getName(), "&7喜欢的食物: 萤石粉", "", "&f免疫掉落伤害"), new ItemStack(Material.GLOWSTONE_DUST), new ItemStack[]{
